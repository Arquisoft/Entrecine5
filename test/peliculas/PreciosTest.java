...
public class PreciosTest extends JUnitStories{

	public PreciosTest() {
		this.configuredEmbedder().candidateSteps().add(new PreciosEscenarios());
	}
	...
	protected List<String> storyPaths() {
		return Arrays.asList("stories/Precios.story");
	}
