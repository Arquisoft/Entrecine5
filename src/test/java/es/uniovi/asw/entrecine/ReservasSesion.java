...
public class ReservasSesion {
	...
	@Entonces("^las butacas ya ocupadas seran (\\d+)$")
	public void las_butacas_ya_ocupadas_seran(int ocupadas) throws Throwable {
		int butacasOcupadas = reservas.size();
		assertThat(ocupadas).isEqualTo(butacasOcupadas);
	}
